...
class TestNakedTwins(unittest.TestCase):
    ...
    def test_naked_twins(self):
        ...
        if solution.naked_twins(self.before_naked_twins_1) not in self.possible_solutions_1:
    ...
    def distest_naked_twins3(self):
        another_test = {"G7": "1569", "G6": "134568", "G5": "13568", "G4": "134568", "G3":
                ...
                "1234569"}
        print('original')
        solution.display(another_test)
        solution.naked_twins(another_test)
